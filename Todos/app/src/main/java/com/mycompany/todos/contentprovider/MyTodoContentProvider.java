package com.mycompany.todos.contentprovider;
...
import com.mycompany.todos.database.TodoDatabaseHelper;
...
public class MyTodoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.mycompany.todos.contentprovider";
    ...
    {
        // using SQLight qury builder
        SQLiteQueryBuilder queryBuilder = new SQLiteQueryBuilder();

        //check if thecaller had requested a colum which dose not exists
        ...
        switch (uriType) {
            case TODOS:
                break;
            case TODO_ID:
                //adding the ID to the origenal Query
        ...
        // make sure that potrnsional listener are getting notified
    ...
    {
        String[] available = { TodoTable.COLUMN_CATEGORY, TodoTable.COLUMN_SUMMARY,
